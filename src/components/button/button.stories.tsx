...
const types = () => (
  <>
    ...
    <Button btnType="primary" className="test" onClick={action('primary button clicked')}>主要按钮</Button>
...
const size = () => (
  <>
    <div style={wrapperStyle}>
      ...
      <Button btnType="primary" size="normal">normal</Button>
      <Button btnType="primary" size="small">small</Button>
      <Button btnType="primary" size="mini">mini</Button>
    </div>
    <div style={wrapperStyle}>
